...
function Cards() {
  return (
    <>
      <div className="flex justify-between items-center w-[80%] py-10 ">
        <div className="w-[45%] bg-[#F46C38] p-10 rounded-2xl flex flex-col justify-between relative">
        ...
        <div className="w-[50%] bg-[#C5FF41] p-10 rounded-2xl flex flex-col justify-between relative">
          ...
          <h1 className="font-bold text-xl py-7 text-black">
